...
?>
    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <li><div style="margin-top:5%;" class="form-inline"> <input type="text" class="form-control" name="search" id="search"/>
<button type="button" class="btn btn-info" id="searchbtn" onclick="searchAction()" >search</button>
<p style="font-size:0.75em; color: tomato; ">search by tags/section/title/body</p></div>
</li>
